              ...
              builder: (context, profileState) {
                ...
                return ListView(
                  ...
                  children: [
                    ...
                    if (profileState case final ProfileReady pr when pr.careGroupOptions.length > 1) ...[
                      const SizedBox(height: 12),
                      Align(
                        alignment: Alignment.centerLeft,
                        child: TextButton.icon(
                          onPressed: () => context.push("/select-care-group?picker=1"),
                    ...
                    _ActionCard(
                      ...
                      subtitle: "Store doses and optional photos; get reminders on this device",
                      onTap: () => context.push("/medications"),
                    ),
                    _ActionCard(
                      icon: Icons.route_outlined,
                      title: "Pathways",
                      subtitle: "Care pathways and guidance for your situation",
                      onTap: () => context.push("/pathways"),
                    ),
                    _ActionCard(
                      icon: Icons.mail_outline,
                      title: "Invitations",
                      subtitle: "People you have invited to your care group",
                      onTap: () => context.push("/invitations"),
                    ),
                    _ActionCard(
                      icon: Icons.note_alt_outlined,
                      title: "Notes",
                      subtitle: "Shared context for carers — general, medical, or legal (restricted read)",
                      onTap: () => context.push("/notes"),
                    ),
                    _ActionCard(
                      icon: Icons.menu_book_outlined,
                      title: "Journal",
                      subtitle: "Dated handover log for carers and principal carers (not for care-only access)",
                      onTap: () => context.push("/journal"),
                    ),
                    _ActionCard(
                      icon: Icons.contact_phone_outlined,
                      title: "Contacts",
                      subtitle: "Shared numbers and notes — GPs, nurses, family, and trusted help",
                      onTap: () => context.push("/contacts"),
                    ),
                    _ActionCard(
                      icon: Icons.groups_2_outlined,
                      title: "Meetings",
                      subtitle: "Team and family reviews — date, place, and agenda (not in care-only mode)",
